...
1. Write scenario_data/scenario_8/chunks/PAM-001_scenario8_chunks.json with
...
3. Write scenario_data/scenario_8/index_registry.json describing the
...
This script writes ONLY to scenario_data/scenario_8/ and tests/fixtures/.
...
SCENARIO_ROOT = REPO_ROOT / "scenario_data" / "scenario_8"
...
BM25_BUNDLE_RELATIVE = f"scenario_data/scenario_8/bm25/{COLLECTION_NAME}.pkl"
