...
## Pipeline Run #32 — scenario_1 — 2026-04-30
**Overall verdict:** PASS
**Supervisor status:** ESCALATED
**Pipeline run id:** run_1df5a0a0c0
**Halted at:** STEP-02

| Step | Agent | Status | Verdict | Elapsed | In tokens | Out tokens |
|------|-------|--------|---------|---------|-----------|------------|
| STEP-01 | intake (deterministic) | COMPLETE | n/a | — | — | — |
| STEP-02 | it_security_agent | ESCALATED | PASS | 5.77s | 20,670 | 558 |
| STEP-03 | legal_agent | PENDING | — | — | — | — |
| STEP-04 | procurement_agent | PENDING | — | — | — | — |
| STEP-05 | checklist_assembler | PENDING | — | — | — | — |
| STEP-06 | checkoff_agent | PENDING | — | — | — | — |

**Totals:** 1 agent call(s), 20,670 input tokens, 558 output tokens, 5.77s cumulative.

**Recorded responses:**
- STEP-02 → `tests/recorded_responses/full_pipeline/pipeline_32__it_security_agent__scenario_1_pass.json`
## Pipeline Run #33 — scenario_2 — 2026-04-30
**Overall verdict:** PASS
**Supervisor status:** ESCALATED
**Pipeline run id:** run_c1c40ae2ae
**Halted at:** STEP-03

| Step | Agent | Status | Verdict | Elapsed | In tokens | Out tokens |
|------|-------|--------|---------|---------|-----------|------------|
| STEP-01 | intake (deterministic) | COMPLETE | n/a | — | — | — |
| STEP-02 | it_security_agent | COMPLETE | PASS | 4.88s | 20,704 | 555 |
| STEP-03 | legal_agent | ESCALATED | PASS | 2.66s | 19,842 | 328 |
| STEP-04 | procurement_agent | PENDING | — | — | — | — |
| STEP-05 | checklist_assembler | PENDING | — | — | — | — |
| STEP-06 | checkoff_agent | PENDING | — | — | — | — |

**Totals:** 2 agent call(s), 40,546 input tokens, 883 output tokens, 7.54s cumulative.

**Recorded responses:**
- STEP-02 → `tests/recorded_responses/full_pipeline/pipeline_33__it_security_agent__scenario_2_pass.json`
- STEP-03 → `tests/recorded_responses/full_pipeline/pipeline_33__legal_agent__scenario_2_pass.json`
## Pipeline Run #34 — scenario_blocked_demo — 2026-04-30
**Overall verdict:** PASS
**Supervisor status:** BLOCKED
**Pipeline run id:** run_f581a302cf
**Halted at:** STEP-04

| Step | Agent | Status | Verdict | Elapsed | In tokens | Out tokens |
|------|-------|--------|---------|---------|-----------|------------|
| STEP-01 | intake (deterministic) | COMPLETE | n/a | — | — | — |
| STEP-02 | it_security_agent | COMPLETE | PASS | 25.45s | 26,517 | 312 |
| STEP-03 | legal_agent | COMPLETE | PASS | 22.93s | 20,809 | 154 |
| STEP-04 | procurement_agent | BLOCKED | PASS | 23.85s | 17,945 | 51 |
| STEP-05 | checklist_assembler | PENDING | — | — | — | — |
| STEP-06 | checkoff_agent | PENDING | — | — | — | — |

**Totals:** 3 agent call(s), 65,271 input tokens, 517 output tokens, 72.23s cumulative.

**Recorded responses:**
- STEP-02 → `tests/recorded_responses/full_pipeline/pipeline_34__it_security_agent__scenario_blocked_demo_pass.json`
- STEP-03 → `tests/recorded_responses/full_pipeline/pipeline_34__legal_agent__scenario_blocked_demo_pass.json`
- STEP-04 → `tests/recorded_responses/full_pipeline/pipeline_34__procurement_agent__scenario_blocked_demo_pass.json`
## Pipeline Run #35 — scenario_escalated_step4_demo — 2026-04-30
**Overall verdict:** PASS
**Supervisor status:** ESCALATED
**Pipeline run id:** run_5cac0af317
**Halted at:** STEP-04

| Step | Agent | Status | Verdict | Elapsed | In tokens | Out tokens |
|------|-------|--------|---------|---------|-----------|------------|
| STEP-01 | intake (deterministic) | COMPLETE | n/a | — | — | — |
| STEP-02 | it_security_agent | COMPLETE | PASS | 30.59s | 26,517 | 450 |
| STEP-03 | legal_agent | COMPLETE | PASS | 23.44s | 20,809 | 154 |
| STEP-04 | procurement_agent | ESCALATED | PASS | 24.99s | 20,296 | 67 |
| STEP-05 | checklist_assembler | PENDING | — | — | — | — |
| STEP-06 | checkoff_agent | PENDING | — | — | — | — |

**Totals:** 3 agent call(s), 67,622 input tokens, 671 output tokens, 79.02s cumulative.
...
## Pipeline Run #40 — scenario_1 — 2026-04-30
**Overall verdict:** PASS
**Supervisor status:** COMPLETE
**Pipeline run id:** run_e63ed7a19e

| Step | Agent | Status | Verdict | Elapsed | In tokens | Out tokens |
|------|-------|--------|---------|---------|-----------|------------|
| STEP-01 | intake (deterministic) | COMPLETE | n/a | — | — | — |
| STEP-02 | it_security_agent | COMPLETE | PASS | 2.93s | 20,656 | 290 |
| STEP-03 | legal_agent | COMPLETE | PASS | 2.18s | 19,770 | 158 |
| STEP-04 | procurement_agent | COMPLETE | PASS | 3.31s | 34,126 | 304 |
| STEP-05 | checklist_assembler | COMPLETE | PASS | 62.31s | 51,670 | 557 |
| STEP-06 | checkoff_agent | COMPLETE | PASS | 32.67s | 7,594 | 635 |

**Totals:** 5 agent call(s), 133,816 input tokens, 1,944 output tokens, 103.39s cumulative.

**Recorded responses:**
- STEP-02 → `tests/recorded_responses/full_pipeline/pipeline_40__it_security_agent__scenario_1_pass.json`
- STEP-03 → `tests/recorded_responses/full_pipeline/pipeline_40__legal_agent__scenario_1_pass.json`
- STEP-04 → `tests/recorded_responses/full_pipeline/pipeline_40__procurement_agent__scenario_1_pass.json`
- STEP-05 → `tests/recorded_responses/full_pipeline/pipeline_40__checklist_assembler__scenario_1_pass.json`
- STEP-06 → `tests/recorded_responses/full_pipeline/pipeline_40__checkoff_agent__scenario_1_pass.json`
## Pipeline Run #41 — scenario_1 — 2026-04-30
**Overall verdict:** PASS
**Supervisor status:** COMPLETE
**Pipeline run id:** run_4dfb89826b

| Step | Agent | Status | Verdict | Elapsed | In tokens | Out tokens |
|------|-------|--------|---------|---------|-----------|------------|
| STEP-01 | intake (deterministic) | COMPLETE | n/a | — | — | — |
| STEP-02 | it_security_agent | COMPLETE | PASS | 2.70s | 20,656 | 224 |
| STEP-03 | legal_agent | COMPLETE | PASS | 1.70s | 19,704 | 158 |
| STEP-04 | procurement_agent | COMPLETE | PASS | 3.97s | 34,060 | 301 |
| STEP-05 | checklist_assembler | COMPLETE | PASS | 60.66s | 51,495 | 478 |
| STEP-06 | checkoff_agent | COMPLETE | PASS | 36.81s | 7,451 | 1,214 |

**Totals:** 5 agent call(s), 133,366 input tokens, 2,375 output tokens, 105.83s cumulative.

**Recorded responses:**
- STEP-02 → `tests/recorded_responses/full_pipeline/pipeline_41__it_security_agent__scenario_1_pass.json`
- STEP-03 → `tests/recorded_responses/full_pipeline/pipeline_41__legal_agent__scenario_1_pass.json`
...
## Pipeline Run #45 — scenario_escalated_step4_demo — 2026-05-01
**Overall verdict:** PASS
**Supervisor status:** ESCALATED
**Pipeline run id:** run_89f464af63
**Halted at:** STEP-04

| Step | Agent | Status | Verdict | Elapsed | In tokens | Out tokens |
|------|-------|--------|---------|---------|-----------|------------|
| STEP-01 | intake (deterministic) | COMPLETE | n/a | — | — | — |
| STEP-02 | it_security_agent | COMPLETE | PASS | 8.00s | 26,512 | 456 |
| STEP-03 | legal_agent | COMPLETE | PASS | 1.41s | 20,873 | 154 |
| STEP-04 | procurement_agent | ESCALATED | PASS | 1.36s | 20,360 | 67 |
| STEP-05 | checklist_assembler | PENDING | — | — | — | — |
| STEP-06 | checkoff_agent | PENDING | — | — | — | — |

**Totals:** 3 agent call(s), 67,745 input tokens, 677 output tokens, 10.77s cumulative.

**Recorded responses:**
- STEP-02 → `tests/recorded_responses/full_pipeline/pipeline_45__it_security_agent__scenario_escalated_step4_demo_pass.json`
- STEP-03 → `tests/recorded_responses/full_pipeline/pipeline_45__legal_agent__scenario_escalated_step4_demo_pass.json`
- STEP-04 → `tests/recorded_responses/full_pipeline/pipeline_45__procurement_agent__scenario_escalated_step4_demo_pass.json`
## Pipeline Run #46 — scenario_escalated_step4_demo — 2026-05-01
**Overall verdict:** PASS
**Supervisor status:** ESCALATED
**Pipeline run id:** run_2f3ff15bd4
**Halted at:** STEP-04

| Step | Agent | Status | Verdict | Elapsed | In tokens | Out tokens |
|------|-------|--------|---------|---------|-----------|------------|
| STEP-01 | intake (deterministic) | COMPLETE | n/a | — | — | — |
| STEP-02 | it_security_agent | COMPLETE | PASS | 8.11s | 26,512 | 524 |
| STEP-03 | legal_agent | COMPLETE | PASS | 2.60s | 20,873 | 154 |
| STEP-04 | procurement_agent | ESCALATED | PASS | 1.97s | 20,360 | 67 |
| STEP-05 | checklist_assembler | PENDING | — | — | — | — |
| STEP-06 | checkoff_agent | PENDING | — | — | — | — |

**Totals:** 3 agent call(s), 67,745 input tokens, 745 output tokens, 12.68s cumulative.

**Recorded responses:**
- STEP-02 → `tests/recorded_responses/full_pipeline/pipeline_46__it_security_agent__scenario_escalated_step4_demo_pass.json`
- STEP-03 → `tests/recorded_responses/full_pipeline/pipeline_46__legal_agent__scenario_escalated_step4_demo_pass.json`
- STEP-04 → `tests/recorded_responses/full_pipeline/pipeline_46__procurement_agent__scenario_escalated_step4_demo_pass.json`
## Pipeline Run #47 — scenario_1 — 2026-05-01
**Overall verdict:** PASS
**Supervisor status:** COMPLETE
**Pipeline run id:** run_0014e81619

| Step | Agent | Status | Verdict | Elapsed | In tokens | Out tokens |
|------|-------|--------|---------|---------|-----------|------------|
| STEP-01 | intake (deterministic) | COMPLETE | n/a | — | — | — |
| STEP-02 | it_security_agent | COMPLETE | PASS | 5.63s | 20,656 | 224 |
| STEP-03 | legal_agent | COMPLETE | PASS | 1.90s | 19,704 | 158 |
| STEP-04 | procurement_agent | COMPLETE | PASS | 28.54s | 34,060 | 304 |
| STEP-05 | checklist_assembler | COMPLETE | PASS | 50.82s | 51,479 | 480 |
| STEP-06 | checkoff_agent | COMPLETE | PASS | 36.85s | 7,457 | 620 |

**Totals:** 5 agent call(s), 133,356 input tokens, 1,786 output tokens, 123.75s cumulative.

**Recorded responses:**
- STEP-02 → `tests/recorded_responses/full_pipeline/pipeline_47__it_security_agent__scenario_1_pass.json`
- STEP-03 → `tests/recorded_responses/full_pipeline/pipeline_47__legal_agent__scenario_1_pass.json`
- STEP-04 → `tests/recorded_responses/full_pipeline/pipeline_47__procurement_agent__scenario_1_pass.json`
- STEP-05 → `tests/recorded_responses/full_pipeline/pipeline_47__checklist_assembler__scenario_1_pass.json`
- STEP-06 → `tests/recorded_responses/full_pipeline/pipeline_47__checkoff_agent__scenario_1_pass.json`
